...
import { getJobsCountBySpecialtyController } from '../controllers/admin/getJobsCountBySpecialtyController';
...
adminRouter.get('/count/jobs', getJobsCountBySpecialtyController);
